<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyProducts.aspx.cs" Inherits="demoWebApp2.MyProducts" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbDeltaNov2023ConnectionString %>" DeleteCommand="DELETE FROM [misProductos] WHERE [id] = @id" InsertCommand="INSERT INTO [misProductos] ([Nombre], [Precio], [Existencias]) VALUES (@Nombre, @Precio, @Existencias)" ProviderName="<%$ ConnectionStrings:dbDeltaNov2023ConnectionString.ProviderName %>" SelectCommand="SELECT [id], [Nombre], [Precio], [Existencias] FROM [misProductos]" UpdateCommand="UPDATE [misProductos] SET [Nombre] = @Nombre, [Precio] = @Precio, [Existencias] = @Existencias WHERE [id] = @id">
            <DeleteParameters>
